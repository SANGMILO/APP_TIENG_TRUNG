-- Migration 012: Initial Course Content (Production)
-- Idempotent via ON CONFLICT DO NOTHING
-- Contains educational + config content. No user data.
...
-- Exercise options
INSERT INTO exercise_options (exercise_id, text, is_correct, order_index) VALUES
  ('e0000000-0000-0000-0000-000000000002', 'Xin chào', TRUE, 1),
  ('e0000000-0000-0000-0000-000000000002', 'Tạm biệt', FALSE, 2),
  ('e0000000-0000-0000-0000-000000000002', 'Cảm ơn', FALSE, 3),
  ('e0000000-0000-0000-0000-000000000002', 'Xin lỗi', FALSE, 4),
  ('e0000000-0000-0000-0000-000000000003', '你好', TRUE, 1),
  ('e0000000-0000-0000-0000-000000000003', '再见', FALSE, 2),
  ('e0000000-0000-0000-0000-000000000003', '谢谢', FALSE, 3),
  ('e0000000-0000-0000-0000-000000000003', '对不起', FALSE, 4)
ON CONFLICT (id) DO NOTHING;
